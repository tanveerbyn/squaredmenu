  ...
  return (
    <SafeAreaView>
      <ScrollView>
        ...
        /> */}
        <Image
          source={require("../assets/images/banners/addABuisness.png")}
          style={styles.banner}
        />
        ...
        <View style={styles.inputFields}>
          ...
          {/* <View style={styles.memberView}>
            <View style={styles.featuresView}>
              {data &&
                data.plans.map((plan) => {
                  return (
                    <View key={plan.id} style={styles.featuresView}>
            ...
            <View style={styles.renewView}>
              ...
              <Text style={styles.renewDateText}>
                {data && data.subscription.ends_at}
              </Text>
            </View>
          </View> */}
          ...
          <View style={styles.featuresView}>
            <View style={styles.share}>
              <View>
                <Text style={styles.smallHeadingText}>
                  {strings("Share the app with your friends")} 💜
                </Text>
            ...
            <View>
              ...
              {lang === "en" && (
                <TouchableOpacity
                  ...
                  onPress={() => languageRBSheet.current.open()}
                >
                  <Image
        ...
        <View style={styles.bottomBtn}>
          {data && (
            <TouchableOpacity
              onPress={() =>
                data.has_restaurant === 1
                  ? Linking.openURL(data.web_url)
                  : alert("Please create a restaurant.")
              }
              style={styles.shareBtn}
            >
              <Image
                style={styles.styleImg}
                source={require("../assets/images/icons/share2.png")}
              />
